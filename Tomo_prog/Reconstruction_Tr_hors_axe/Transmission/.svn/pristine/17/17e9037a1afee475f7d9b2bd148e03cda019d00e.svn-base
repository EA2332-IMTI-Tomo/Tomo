...
//        Var2D dim2D= {2*NXMAX,2*NYMAX},decal2D= {NXMAX,NYMAX};
        ...
        for(int cpt_angle=premier_plan; cpt_angle<premier_plan+NbAngle; cpt_angle=cpt_angle+SautAngle) //boucle sur tous les angles
        {
                ...
                if(test_existence!=NULL) {
                       ...
                       ///--------Circshift et TF2D------
                        ...
                        //sauvegarde de la valeur cplx des  spéculaires
        ...
        //SAV(reel_arc, N_tab, "/home/mat/tomo_test/TF2d_apres_masquage/reel_arc_norm_avant.bin", float,"wb");

        //interp3D(reel_arc,  dimVolX,dimVolX, dimVolX);  //////////////interpolation dans Fourier
       ...
       // SAV(reel_arc, N_tab, "/home/mat/tomo_test/TF2d_apres_masquage//home/mat/reel_arc_norm.bin", float,"a+b");*/
