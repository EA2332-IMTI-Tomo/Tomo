...
NA=1.4,	//ouverture numerique de l'objectif? (celle du condenseur intervient sur la forme, la taille, du papillon)
...
//Mat masqueC=imread("vlsi480.jpg",0);
...
*/
    if(test_existence!=NULL)
    {
		...
		//calculPlan1(holo1, holo2, holo3, holo4, plan_reel, plan_imag, DIMY_CCD2, coin, Fichier_holo, masque, mod_ref, supRedonPlanN, supRedonPlan, dimFin.x);
...
///########################################TF 2D du front d'onde: passage du plan image au plan réciproque##########################
        ...
        //SAV(plan_imag_shift, N, "/home/hui/maniptomo/IDP/champ_2d/plan_reel_shift.bin", FLOAT,"a+b");
...
///____________________________ Calcul module spectre et trouver le maximum de chaque pixel pour tous les angles
        ...
        SAV(plan_reel_norm_shift, dimFin.x*dimFin.y, "/home/hui/maniptomo/IDP/champ_2d/planHolo.bin", FLOAT,"a+b");
...
// ///____________________________ normaliser les plans par supRedonPlan
//        for(int cpt=0;cpt<dimFin.x*dimFin.y;cpt++)
//        {
//            if(supRedonPlan[cpt]==0)
//            {
//                supRedonPlan[cpt]=supRedonPlan[cpt]+1;
//            }
//            plan_reel_norm[cpt]=plan_reel_norm[cpt]/supRedonPlan[cpt];
//            plan_imag_norm[cpt]=plan_imag_norm[cpt]/supRedonPlan[cpt];
//        }
//        delete[] supRedonPlan;
//        SAV(plan_reel_norm, dimFin.x*dimFin.y, "/home/hui/maniptomo/IDP/champ_2d/planHoloNorm.bin", FLOAT,"a+b");
...
//ContrSpeckle(plan_amp_norm, dimFin.x, contrSpeckle);
...
///################################################sans corrélation croisée#########################################################
        ...
        SAV(distMod1pi, dimFin.x*dimFin.y, "/home/hui/maniptomo/IDP/champ_2d/phaseMod1pi.bin", FLOAT,"a+b");
...
//corrPhase(phaseMod1pi,phaseMod1piFit,dimFin.x, masqueC);
for(int cpt=0; cpt<dimFin.x*dimFin.y; cpt++)
{
    distMod1pi[cpt] = phaseMod1pi[cpt]*lambda*pow(10,9)/(4*PI*n1);
}
write_data("/home/hui/maniptomo/IDP/champ_2d/phaseMod1piSyn2D.bin",distMod1pi,image_size);
...
SAV(distSyn2D, dimFin.x*dimFin.y, "/home/hui/maniptomo/IDP/champ_2d/distanceSyn2D_avantcorraber.bin", FLOAT,"a+b");
SAV(distSyn2DFit, dimFin.x*dimFin.y, "/home/hui/maniptomo/IDP/champ_2d/distanceSyn2D_aprescorraber.bin", FLOAT,"a+b");
